...
ggsave(widthplot, file='readlengths_matk.png')
...
ggsave(qscores, file='quality_matk.png')
...
write.csv(cltax, file='blasthits_matk.csv')



kreport = read.table('/projectnb/ct-shbioinf/vrapela/Kraken2_compare/kreport_matk.tab', sep='\t')
blasthits = read.csv('blasthits_matk.csv')
kout = read.table('/projectnb/ct-shbioinf/vrapela/Kraken2_compare/kout_matk.txt', sep='\t')
...
ggsave(gr, file='Blast_grid_taxonomy_matk.png', height = 9, width = 5, dpi=500)
...
ggsave(kgr, file='Kraken_grid_taxonomy_matk.png', height = 11, width = 7, dpi=500)
