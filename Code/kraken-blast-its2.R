...
report_file='kreport_its2.tab'
SRR_file=list.files(pattern=srr)
out_file='kout_its2.txt'
...
ggsave(widthplot, file='readlengths_its2.png')
...
ggsave(qscores, file='quality_its2.png')
...
write.csv(cltax, file='blasthits_its2.csv')



kreport = read.table('/projectnb/ct-shbioinf/vrapela/Kraken2_compare/kreport_its2.tab', sep='\t')
blasthits = read.csv('blasthits_its2.csv')
kout = read.table('/projectnb/ct-shbioinf/vrapela/Kraken2_compare/kout_its2.txt', sep='\t')
...
ggsave(gr, file='Blast_grid_taxonomy_its2.png', height = 9, width = 5, dpi=500)
...
ggsave(kgr, file='Kraken_grid_taxonomy_its2.png', height = 20, width = 7, dpi=500)
